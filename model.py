...
class FreqShowModel(object):
	def __init__(self, width, height):
		...
		# RTL-SDR Kütüphanesini yüklüyoruz.
		self.sdr = RtlSdr()
	...
	def _clear_intensity(self):
        ...
        # Frekans ayarlanması ve setlenmesi.
	...
	def set_center_freq(self, freq_mhz):
        ...
        # Sample Rate ayarlanması ve setlenmesi.
	...
	def set_sample_rate(self, sample_rate_mhz):
        ...
        # Kazancın ayarlanması ve setlenmesi. 
	...
	def set_gain(self, gain_db):
        ...
        # Maksimum ve Minimum kullanılacak güç.
	...
	def set_max_intensity(self, intensity):
        ...
        # Spektrogram için FFT Hesaplanması
